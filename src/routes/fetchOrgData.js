...
function getDashData(organisation) {
    return __awaiter(this, void 0, void 0, function () {
        var querystring, data, error_1, response, _i, _a, node, contri, contributors, issueList, repository;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    issueList = node.openIssues.nodes.map(function (_a) {
                        var url = _a.url, number = _a.number, title = _a.title, author = _a.author, body = _a.body;
                        return ({
                            number: number,
                            title: title,
                            url: url,
